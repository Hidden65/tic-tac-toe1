...
function authenticate() {
    ...
    if (passwordEntered === 'true') {
        // Password has already been entered, proceed to initialize the game
        initializeGame();
    } else {
        ...
        if (password === 'putu') {
            // Set a session storage flag indicating that the password has been entered
            sessionStorage.setItem('passwordEntered', 'true');
             // Display Valentine's Day alert
            alert("Happy Valentine's Day! Enjoy the game!");
            initializeGame();
